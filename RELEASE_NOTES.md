...
**Commits:** `722ee69` (W2-1 + W2-2), `6b05285` (case analysis + fix plan), `da2b5d8` (icon colour), `00e4084` (Status Guide), `767d147` (NSPopover), `390bc53`/`dda961c` (NSPopover hardening), `3b57f14` (single-source version), `7901afc` (NSPopover checkbox fix), `db5db60` (config merge-save), `83ef0d1` (logo assets)
